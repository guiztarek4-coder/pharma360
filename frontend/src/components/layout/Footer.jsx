      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">{settings.tagline}. Soins, cosmétiques authentiques et bien-être livrés à Alger.</p>
            <div className="flex gap-2 mt-4">
              <a href={settings.facebook} className="w-9 h-9 rounded-lg bg-white/5 hover:bg-mint-600 grid place-items-center transition-colors" data-testid="social-facebook"><Facebook className="w-4 h-4" /></a>
              <a href={settings.instagram} className="w-9 h-9 rounded-lg bg-white/5 hover:bg-mint-600 grid place-items-center transition-colors" data-testid="social-instagram"><Instagram className="w-4 h-4" /></a>
            </div>
          </div>
